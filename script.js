...
const localStorageCartNr = (localStorage.getItem('cartItems') === undefined) ? 0 : localStorage.getItem('cartItems');
...
function putActiveClass (allImages, activeEl) {
  document.querySelectorAll("." + allImages).forEach( image => image.classList.remove('active'));
